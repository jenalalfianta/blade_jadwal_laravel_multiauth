<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.ruang.index')" :active="request()->routeIs('admin.ruang.index') || request()->routeIs('admin.ruang.create') || request()->routeIs('admin.ruang.edit')">
                        {{ __('Ruang') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.ruang.index')" :active="request()->routeIs('admin.ruang.index')">
                {{ __('Ruang') }}
            </x-responsive-nav-link>
        </div>
